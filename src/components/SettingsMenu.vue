<template>
  <div v-if="isMenuOpen" class="absolute top-14 right-0 bg-white shadow-lg p-4 w-64">
    ...
    <button @click="saveSettings" class="bg-blue-500 w-full flex justify-center items-center h-10 text-white">Save</button>
...
const saveSettings = () => {
  emit('saveSettings', { goalWeight: goalWeight.value, unit: props.unit }); // Use the reactive goalWeight
};
